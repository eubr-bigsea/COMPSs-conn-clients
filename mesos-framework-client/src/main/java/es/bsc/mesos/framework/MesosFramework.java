...
public class MesosFramework {
    ...
    public MesosFramework(Map<String, String> props) throws FrameworkException {
        ...
        // Let mesos fill the current user
        FrameworkInfo.Builder frameworkBuilder = FrameworkInfo.newBuilder()
                .setFailoverTimeout(FAILOVER_TIMEOUT).setUser("").setName(FRAMEWORK_NAME);
        ...
        try {
            ...
            driver.stop();
            throw new FrameworkException(fe.getMessage() + " Mesos master IP: " + mesosMasterIp);
        }
    }
    ...
    public String waitWorkerUntilRunning(String id) {
        ...
        try {
            ...
            LOGGER.warn("Exception raised waiting for worker " + id + ": " + fe.getMessage());
        }
    ...
    public void removeWorker(String id) {
        ...
        try {
            ...
            LOGGER.warn("Could not remove worker: " + fe.getMessage());
        }
    }
