...
public class JobDescription {
	...
	private HashMap<String,String> jobProperties;
	...
	public JobDescription(HashMap<String, String> jobProp){
	...
	private static void addNodesInInterval(String numInterval, String nodeRoot,
